...
s.author       = "Team"
s.platform     = :ios, "11.2"
s.source       = {:git => 'https://bitbucket.org/vdopia/sdkdistribution.git',:tag => '4.1.3'}
...
s.vendored_libraries = "libGoogleIMA_Mediator.a"
s.dependency 'Chocolate_SDK', '~> 1.0.0'
s.dependency 'GoogleAds-IMA-iOS-SDK', '~> 3.6.1'
s.requires_arc = true
end
